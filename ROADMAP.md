...
_Where PopStrip is headed — a faithful, modern Photo Booth for the web. Last updated: 2026-07-02_
...
- **[v2.0.0](https://github.com/manlycucumber/popstrip/milestone/5) — Video.** Movie-clip mode (webm), then mp4 (WebCodecs) and GIF / boomerang.
